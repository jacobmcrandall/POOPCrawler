...
namespace DungEon
{
    /*
        ...
        TODO - add in labels for health,attack & level
    ...
    public class GameLayer : CCTileMap
    {
        ...
        void RunGameLogic(float frameTimeInSeconds)
        {
            ...
            foreach (character enemy in enemiesList)
            {
                ...
                if (!isUserNear(positionAsTile))
                    ...
                    Console.WriteLine("Attacking the user for: " + enemy.weapon.attack);
            }
        ...
        void tileHandler(CCPoint world, CCTileMapLayer layer, Boolean calledByLoop=false)
        {
            ...
            if (!calledByLoop && properties != null && properties.ContainsKey("walkable") && properties["walkable"] == "true")
            {
                ...
                {
                    //get that specific enemy from the list
                    Console.WriteLine("Attacking enemy for: " + user.weapon.attack);
                }
        ...
        //check if another enemy occupies that tile
